...
import deved from "../public/dev-p.png";
...
import youtube from '../public/assets/covid.png'
      ...
      <main className='bg-white px-10 md:px-20  lg:px-32 dark:bg-black' >
        <section id='home' className='min-h-screen '>
          ...
          <nav className=' flex justify-between py-10 mb-12'>
            <h1 className='text-xl font-burtons dark:text-white'>helloaryan</h1>
            <ul className='flex items-center'>
              ...
              <li className='ml-4 bg-gradient-to-r from-cyan-500 to-teal-500 text-white rounded px-4 py-1'><a href='https://drive.google.com/file/d/1TkC-CQ5zMLQOIkH2Xb5Sg0bsXm1-FvaH/view?usp=sharing' download="Resume" target="_blank" >Resume</a> </li>
            </ul>
          </nav>
          {/* some about text */}
          <div className=' text-center p-10'>
            <h2 className='text-4xl py-2 text-teal-600 font-medium md:text-6xl'>Aryan Maurya</h2>
            ...
            <p className='py-5 leading-8 text-gray-800 max-w-xl mx-auto dark:text-gray-400'>
              Hello Im a Frontend developer providing services for programming and design content
          ...
          <div className='text-5xl flex   justify-center gap-16 text-gray-600 dark:text-gray-300 '>
            <a href="mailto:aryanmaurya63946048@gmail.com" target='_blank'><MdEmail /></a>
            <a href='https://www.linkedin.com/in/aryan-maurya-4aa352206/' target='_blank' ><AiFillLinkedin /></a>
            <a href='https://leetcode.com/jatinlodhi111/' target='_blank' ><SiLeetcode /></a>
            <a href='https://github.com/Aryanmaury' target='_blank'><BsGithub /></a>
          </div>
        ...
        <section id='project' className='pb-20'>
          ...
          <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
            ...
            <motion.div
              ...
              <a href='https://gamicscontrolnetlifiapp.netlify.app/' target='_blank'><div className='cursor-pointer text-xl text-white absolute -bottom-full left-1/3 z-40 group-hover:bottom-1/2 transition-all duration-500'>Live</div></a>
              ...
              <a href='https://github.com/Aryanmaury/gamicscontrol.github.io' target='_blank'><div className='cursor-pointer text-xl text-white absolute -bottom-full left-2/3 z-40 group-hover:bottom-1/2  transition-all duration-700'>Code </div></a>
            </motion.div>
            <motion.div
              ...
              <a href='https://covid-19simplewebsite.netlify.app/' target='_blank'><div className='cursor-pointer text-xl text-white absolute -bottom-full left-1/3 z-40 group-hover:bottom-1/2 transition-all duration-500'>Live</div></a>
              <a href='https://github.com/Aryanmaury/Covid-19.gihub.io' target='_blank'><div className='cursor-pointer text-xl text-white absolute -bottom-full left-2/3 z-40 group-hover:bottom-1/2  transition-all duration-700'>Code </div></a>
            </motion.div>
            <motion.div
              variants={fadeIn('right', '0.3')}
              initial='hidden'
              ...
              <a href='https://aryanmaury.github.io/Yoga-life/' target='_blank'><div className='cursor-pointer text-xl text-white absolute -bottom-full left-1/3 z-40 group-hover:bottom-1/2 transition-all duration-500'>Live</div></a>
              <a href='https://github.com/Aryanmaury/Yoga-life' target='_blank' ><div className='cursor-pointer text-xl text-white absolute -bottom-full left-2/3 z-40 group-hover:bottom-1/2  transition-all duration-700'>Code </div></a>
            </motion.div>
            <motion.div
              variants={fadeIn('left', '0.3')}
              initial='hidden'
              ...
              <a href='https://portfolio-tailwind-css.netlify.app/' target="_blank"><div className='cursor-pointer text-xl text-white absolute -bottom-full left-1/3 z-40 group-hover:bottom-1/2 transition-all duration-500'>Live</div></a>
              <a href='https://github.com/Aryanmaury/portfolio.github.io.git' target='_blank'><div className='cursor-pointer text-xl text-white absolute -bottom-full left-2/3 z-40 group-hover:bottom-1/2  transition-all duration-700'>Code </div></a>
            </motion.div>
          </div>
        </section>
